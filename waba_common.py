...
def check_file_exists(country: str, data_type: str, prefix: str, **context) -> None:
    ...
    existe pour ce pays/jour avant de lancer l'ingestion. Si absent, lève une
    exception : la tâche d'ingestion en aval ne s'exécute jamais
    (statut upstream_failed).
    """
    ...
    if response.get("KeyCount", 0) == 0:
        raise AirflowException(
            ...
            f"(prefix cherché: {key_prefix}) — ingestion annulée pour ce pays."
        )
